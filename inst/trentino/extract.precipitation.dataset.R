...
wpath <- "/Users/ecor/Dropbox/hydropica/sourcesR/geotopbricks_private/simulation_idroclima_template"
...
## set names #
names_metadata_f <- "/Users/ecor/Dropbox/iasma/RMAWGENdev/ncdf4df/inst/trentino/metadata/station.csv"
...
start_date <- as.POSIXct("2005-03-01 00:00:00",tz=tz)
end_date <- as.POSIXct("2007-02-28 23:00:00",tz=tz)
...
## 
ncname <- "trentino_hourlyweatherdata"
ncpath <- "/Users/ecor/Dropbox/iasma/RMAWGENdev/ncdf4df/inst/trentino/data" 
